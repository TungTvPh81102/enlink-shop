...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-6 pt-md-0 pt-10">
                <p class="d-flex align-items-center mb-6">
                        <span id="getProductPrice"
                              class="text-decoration-line-through"></span>
                    <span
                        id="getPriceSale"
                        class="fs-18px text-body-emphasis ps-6 fw-bold"></span>
                            ...
                            @foreach($product->variants as $key => $value)
                                ...
                                @if(!in_array($colorCode, $displayedColors))
                                    ...
                                    <li class="list-inline-item me-4 fw-semibold ">
                                        <input
                                            type="radio"
                                            id="colorRadio{{ $colorCode }}"
                                            name="color_id"
                                            {{ $key == 0 ? 'checked' : '' }}
                                            class="product-info-color d-none getSizePrice"
                                            value="{{ $value->color->id }}"
                                            data-color="{{ $colorCode }}"
                                            data-quantity="{{  $value->quantity}} "
                                            data-prices='{{ $product->variants->where("color.code", $colorCode)->pluck("price", "size.name")}} '
                                        />
                                        <label
                                            style="cursor: pointer"
                                            for="colorRadio{{ $colorCode }}"
                                            class="fs-14px p-4 d-block rounded text-decoration-none border"
                                        >{{ $colorCode }}</label>
                                    </li>
                ...
                <ul class=" list-unstyled border-top pt-7 mt-7">
                    ...
                    <li class="d-flex mb-4 pb-2 align-items-center">
                        ...
                        <span class="ps-4">
                                ...
                                <span
                                    class="ps-4"> {{ $product->category->parent->name ?? 'No Parent Category' }},</span>
                            @endif
    ...
    @if(!empty($productRelated->count()))
        ...
        <section class="container container-xxl pt-15 pb-15 pt-lg-17 pb-lg-20">
            <div class="text-center"><h2 class="mb-12">Sản phẩm cùng loại</h2></div>
            <div
                class="slick-slider"
        ...
        <div class="row">
            <div class="col-xl-3 col-md-5">
                <div class="position-sticky top-0 mb-md-0 mb-12">
                    <div
                        class="card text-center border border-2 rounded product-review-info"
                    >
                        <div class="card-body px-4 py-10">
                            <h5 class="card-title fs-1 mb-6">4.86</h5>
                            <div
                                class="d-flex align-items-center fs-15px ls-0 justify-content-center mb-4"
                            >
                                <div class="rating">
                          ...
                          <svg class="icon star text-primary">
                            ...
                            <div class="mb-8">
                                ...
                                >
                                    ...
                                    <div
                                        class="mx-5 d-block mw-160px mw-lg-120px mw-sm-60 w-100"
                                    >
            ...
            <div class="ps-lg-12 ps-auto col-xl-9 col-md-7">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group mb-7">
                                    <label
                                        class="mb-4 fs-6 fw-semibold text-body-emphasis"
                                        for="reviewName"
                                    >Name</label
                                    >
                                    <input
                ...
                <div class="product-filter-review">
                    ...
                    <ul class="list-inline mb-8 mx-n3 filter-review">
                        ...
                        <li
                            class="collapse m-3 list-inline-item collapse"
                            id="collapseExample"
                        >
                    ...
                    <div class="row gy-15px align-items-center spacing-02">
                        <div class="col-auto search-review w-100 px-4">
                            <div class="form-group product-review-form">
                                <div
                                    class="input-group-prepend position-absolute z-index-10"
                                >
                                    <button
                                        class="btn btn-link text-secondary fs-15px px-7"
                                        type="submit"
                                    >
                                ...
                                <input
                                    ...
                                    id="search_reviews"
                                    name="search_reviews"
                                    class="form-control fs-15px pe-7 ps-13 rounded"
                                    placeholder="Search reviews"
                                />
                                <label for="search_reviews" class="visually-hidden"
                                >Search reviews</label
                                >
                            </div>
                        </div>
                        <div class="col-auto dropdown skin-goal px-4">
                            <label for="skin_goal" class="visually-hidden"
                            >Skin goal</label
                            >
                        ...
                        <div class="col-auto dropdown skin-goal px-4">
                            <label for="image_video" class="visually-hidden"
                            >Image &amp; Video</label
                            >
                            <select
                                name="image_video"
                ...
                <div class="mt-12">
                    ...
                    <div class="border-bottom pb-7 pt-10">
                        ...
                        >
                            <img
                                src="#"
                                data-src="../assets/images/others/single-product-01.png"
                                class="me-6 lazy-image rounded-circle"
                                width="60"
                                height="60"
                                alt="Avatar"
                            />
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="#" class="fs-14px mb-0 text-secondary"
                    ...
                    <div class="border-bottom pb-7 pt-10">
                        ...
                        <div class="mb-10">
                            <img
                                src="#"
                                data-src="../assets/images/others/single-product-03.jpg"
                                class="mx-3 w-auto lazy-image"
                                alt
                            />
                            <img
                                src="#"
                                data-src="../assets/images/others/single-product-02.jpg"
                                class="mx-3 w-auto lazy-image"
                                alt
                            />
                        </div>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            const salePercentage = {{ $product->price_sale }};
            ...
            function updatePrice() {
                ...
                if (selectedColorInput) {
                    let prices = JSON.parse(selectedColorInput.dataset.prices);
                    let price = prices[selectedSize];

                    if (price) {
                        document.querySelector('#getProductPrice').innerText = formatNumber(price);
                        if (salePercentage > 0) {
                            let finalPrice = calculateDiscountedPrice(price);
                            document.querySelector('#getPriceSale').innerText = formatNumber(finalPrice);
                        } else {
                            document.querySelector('#getPriceSale').style.display = 'none';
                            document.querySelector('#getProductPrice').innerText = formatNumber(price);
                            document.querySelector('#getProductPrice').classList.remove('text-decoration-line-through');
                            document.querySelector('#getProductPrice').classList.add('fs-18px', 'text-body-emphasis', 'fw-bold');
                        }
                    } else {
                        document.querySelector('#getProductPrice').innerText = formatNumber(price);
                        document.querySelector('#getPriceSale').innerText = formatNumber(price);
                    }
                } else {
                    document.querySelector('#getProductPrice').innerText = formatNumber(price);
                    document.querySelector('#getPriceSale').innerText = formatNumber(price);
