                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 class="m-b-0 m-l-10">
                                        <img class=" rounded" style="width: 100px; height: 100px" src="{{  Storage::url($item->image) }}" alt=" {{ $item->name }}">
                                    </h6>
                                </td>
                                <td>
                                    {{ $item->name }}
                                ...
                                <td class="text-right">
                                    <a class="btn btn-success" href="{{ route('admin.brands.restore', $item->id) }}">Khôi phục</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
                    <a class="btn btn-primary mt-4" href="{{ route('admin.brands.index') }}">Danh sách</a>
                </div>
            </div>
        </div>
    </div>
