        ...
        <div class="modal-content">
            ...
            <div class="modal-body scrollable">
                ...
                <div class="m-t-30">
                    ...
                    <div class="d-flex m-b-30">
                        <div class="avatar avatar-image">
                            <img src="{{ asset('assets/backend/images/avatars/thumb-1.jpg')}}" alt="">
                        </div>
                        <div class="m-l-15">
                    ...
                    <div class="d-flex m-b-30">
                        <div class="avatar avatar-image">
                            <img src="{{ asset('assets/backend/images/avatars/thumb-2.jpg')}}" alt="">
                        </div>
                        <div class="m-l-15">
                    ...
                    <div class="d-flex m-b-30">
                        <div class="avatar avatar-image">
                            <img src="{{ asset('assets/backend/images/avatars/thumb-3.jpg')}}" alt="">
                        </div>
                        <div class="m-l-15">
                ...
                <div class="m-t-30">
                    ...
                    <div class="d-flex m-b-30">
                        <div class="avatar avatar-image">
                            <img src="{{ asset('assets/backend/images/others/img-1.jpg')}}" alt="">
                        </div>
                        <div class="m-l-15">
