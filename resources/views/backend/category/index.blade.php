                    ...
                    <table class="table table-hover e-commerce-table">
                        ...
                        @foreach($categories as $item)
                            <tr>
                                <td>
                                    <div class="checkbox ">
                                        <input class="category-checkbox" value="{{ $item->id }}" id="check-item-1" type="checkbox">
                                ...
                                <td>
                                    {!!   !$item->parent_id ?
                                        '<span class="badge badge-primary">Danh mục cha</span>' :
                                        '<span class="badge badge-info">Danh mục con</span>' !!}
                                </td>
                                <td>
                                    {!!   $item->status ?
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{ route('admin.categories.destroy', $item->id) }}" class="btn btn-icon btn-hover btn-sm btn-rounded sweet-confirm">
