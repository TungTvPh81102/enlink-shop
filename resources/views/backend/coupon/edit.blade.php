                ...
                <form action="{{ route('admin.coupons.update',$coupon->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="" class="form-control mb-3">
                            ...
                            <option {{ old('type', $coupon->type) == 'fixed' ? 'selected' : '' }} value="fixed">Giảm
                                theo tiền
                            </option>
                        </select>
                        @error('type')
                    ...
                    <div class="form-group" id="max_discount_percentage_group" style="display: none;">
                        ...
                        <input type="number" class="form-control mb-3" id="max_discount_percentage" name="max_discount_percentage"
                               value="{{ old('max_discount_percentage', $coupon->max_discount_percentage) }}"
                    ...
                    <div class="form-group ">
                        ...
                        <input type="number" class="form-control mb-3" name="max_uses"
                    ...
                    <div class="form-group ">
                        <div class="form-group">
                            ...
                            <div class="input-affix m-b-10">
                                ...
                                <input value="{{ old('expire_date', $coupon->expire_date) }}" type="text"
                                       name="expire_date" class="form-control datepicker-input"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="" class="form-control mb-3">
                            <option>--- Chọn ---</option>
                            <option {{ old('status', $coupon->status) ? 'selected' : ''  }} value="1">Active</option>
                            <option {{ !old('status', $coupon->status) ? 'selected' : ''  }} value="0">Inactive</option>
                        </select>
                        @error('status')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
