                                        ...
                                        <td>
                                            <div class="media align-items-center">
                                                <div class="avatar avatar-image rounded">
                                                    <img
                                                        src="{{ asset('assets/backend/images/others/thumb-9.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="m-l-10">
                                                    <span>Gray Sofa</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <div class="avatar avatar-image rounded">
                                                    <img
                                                        src="{{ asset('assets/backend/images/others/thumb-10.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="m-l-10">
                                                    <span>Gray Sofa</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <div class="avatar avatar-image rounded">
                                                    <img
                                                        src="{{ asset('assets/backend/images/others/thumb-11.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="m-l-10">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <div class="avatar avatar-image rounded">
                                                    <img
                                                        src="{{ asset('assets/backend/images/others/thumb-12.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="m-l-10">
                                                    <span>Red Chair</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <div class="avatar avatar-image rounded">
                                                    <img
                                                        src="{{ asset('assets/backend/images/others/thumb-13.jpg')}}"
                                                        alt="">
                                                </div>
                                                <div class="m-l-10">
                                                    <span>Wristband</span>
                                        ...
                                        <div class="timeline-item-content">
                                            <div class="m-l-10">
                                                ...
                                                <p class="m-b-0">
                                                    <span class="font-weight-semibold">Commented  </span>
                                                    <span
                                                        class="m-l-5"> 'Hi, please done this before tommorow'</span>
                                                </p>
                                                <span class="text-muted font-size-13">
                                                                <i class="anticon anticon-clock-circle"></i>
                                                                <span class="m-l-5">8:34 PM</span>
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label for="task-today-1" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Define users and workflow</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-today-2" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Schedule jobs</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-today-3" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Extend the data model</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-today-4" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Change interface</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-today-5" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Create databases</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-week-1" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Verify connectivity</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-week-2" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Order console machines</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-week-3" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Customize Template</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-week-4" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Batch schedule</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-week-5" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Prepare implementation</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-month-1" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Create user groups</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-month-2" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Design Wireframe</span>
                                                                <span class="m-b-0 text-muted font-size-13 d-block">Value proposition alpha crowdsource</span>
                                                            </span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-month-4" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Management meeting</span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="checkbox">
                                            ...
                                            <label for="task-month-5" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Extend data model</span>
